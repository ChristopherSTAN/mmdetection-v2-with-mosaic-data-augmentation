...
from .WheatTest import WheatDatasetTest
...
__all__ = [
    ...
    'WIDERFaceDataset', 'DATASETS', 'PIPELINES', 'build_dataset', 'MosaicDataset',
    'MosaicCocoDataset', 'MyMosaicDataset', 'WheatDatasetTest', 'MyCocoDataset'
]
